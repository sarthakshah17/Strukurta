    ...
    <section className="container mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm text-center">
          ...
          <a href="mailto:sales@untitledui.com" className="text-blue-500 mt-2 inline-block">sales@untitledui.com</a>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm text-center">
          ...
          <a href="mailto:support@untitledui.com" className="text-blue-500 mt-2 inline-block">support@untitledui.com</a>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm text-center">
          ...
          <a href="https://www.google.com/maps" className="text-blue-500 mt-2 inline-block">View on Google Maps</a>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm text-center">
          ...
          <a href="tel:+1555000000" className="text-blue-500 mt-2 inline-block">+1(555) 000-0000</a>
        </div>
      </div>
    </section>
    </>
